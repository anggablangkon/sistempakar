            ...
            <div class="col-sm-7">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <?php $kdgejala = $_POST['oke']; ?>
                  <?php foreach ($kdgejala as $tampil) { ?>
                  <?php $query = mysqli_query($connection, "SELECT *, sum(nilaimb) as nilai FROM tbl_basispengetahuan WHERE kd_gejala = '$tampil' GROUP BY kd_penyakit "); ?>
                  <?php while($tampil1 = mysqli_fetch_array($query)){ ?>
